...
import { DropdownMenu, DropdownMenuGroup,DropdownMenuSubContent,DropdownMenuSubTrigger, DropdownMenuPortal, DropdownMenuSub, DropdownMenuContent, DropdownMenuTrigger, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuItem} from '@radix-ui/react-dropdown-menu';
  ...
  return (
    <div className='grid lg:grid-cols-[200px_1fr] grid-rows-3  md:grid-cols-[100px_1fr] w-full h-screen'>
      ...
      <DropdownMenuTrigger asChild>
        <button className='border-none bg-none hover:border-none'> <UserCircle /></button>
      </DropdownMenuTrigger>
